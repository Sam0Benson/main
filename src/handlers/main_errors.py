...
from src.keyboards.inline_page import products_item_position_swipe_fp, products_item_category_swipe_fp
from src.services.api_sqlite import get_categoryx, get_all_categoriesx, get_positionx, get_positionsx
